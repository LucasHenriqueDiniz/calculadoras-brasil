...
export const Route = createFileRoute("/blog/como-calcular-salario-pj")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Passo a passo: calcule seu salário PJ descontando INSS, IRPF, contador." },
    ],
...
function BlogPost() {
  return (
    <PageShell>
      <article>
        <PageHeader eyebrow="guia • 7 min" title="Como Calcular Salário PJ" description="Fórmula completa para calcular ganho líquido como PJ." />
        <Prose>
          ...
          <p>R$ 10.000 - R$ 2.000 - R$ 500 - R$ 1.125 = <strong>R$ 6.375 líquido</strong></p>

          <h2>Regra Rápida</h2>
          <p>PJ recebe ~60-65% do valor bruto em líquido (restante vai para impostos).</p>

          <h2>Use a Calculadora</h2>
          <p>Simule sua situação específica na calculadora CLT vs PJ. Varia conforme dependentes e deduções.</p>
        </Prose>
        <RelatedCalculators />
      </article>
    </PageShell>
