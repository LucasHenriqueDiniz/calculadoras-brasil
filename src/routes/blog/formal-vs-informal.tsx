    ...
    <PageShell>
      <article>
        <PageHeader
          ...
          description="Quando vale a pena se registrar como autônomo."
        />
        <Prose>
          <h2>Informal</h2>
          <p>
            <strong>Custo:</strong> R$ 0/mês
          </p>
          <p>
            <strong>Imposto:</strong> Pode não pagar nada
          </p>
          <p>
            <strong>Problema:</strong> Sem direitos trabalhistas, sem comprovação de renda, sem
            aposentadoria
          </p>

          <h2>Formal (Autônomo Registrado)</h2>
          <p>
            <strong>Custo:</strong> R$ 65-70/mês (DAS)
          </p>
          <p>
            <strong>Benefício:</strong> INSS, aposentadoria, auxílio-doença, maternidade
          </p>
          <p>
            <strong>Vantagem:</strong> Comprovação de renda para banco, crédito imobiliário
          </p>

          <h2>MEI</h2>
          <p>
            <strong>Custo:</strong> R$ 65-70/mês
          </p>
          <p>
            <strong>Faturamento até:</strong> R$ 81.000/ano
          </p>
          <p>
            <strong>Imposto:</strong> Isento (até limite)
          </p>
